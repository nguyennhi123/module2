...
public class Customer extends DBConnection{
        ...
        public List<Customer> getAllCustomer() throws SQLException{
           ...
           return rowInserted;
            ...
            statement.setInt(4,customer.getIdcustomer());
            boolean rowInserted = statement.executeUpdate()>0;
            statement.close();
            try {
                statement.close();
            ...
            String sql = "SELECT customerName,phone, address FROM Customer WHERE idcustomer = ?";
            DBConnection dbConnection = new DBConnection();
            Connection conn = dbConnection.getConnection();
            PreparedStatement statement = null;
            try {
            ...
            if (resultSet.next()){
                ...
                String phone = resultSet.getString("phone");
                String address = resultSet.getString("address");
                customer = new Customer(idcustomer,customerName,phone,address);
            }
            resultSet.close();
            statement.close();
            return customer;
