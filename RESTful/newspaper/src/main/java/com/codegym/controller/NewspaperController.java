...
public class NewspaperController {
    ...
    public ModelAndView listNewspapersEn(@RequestParam("sE") Optional<String> sE, Pageable pageable) {
        ...
        if (sE.isPresent()) {
            newspapers = newspaperService.findAllByTittleContaining(sE.get(), pageable);
        } else {
    ...
    public ModelAndView showCreateForm(){
        ...
        modelAndView.addObject("newspaper",new Tintuc());
        return modelAndView;
    }
    ...
    public String deleteNewspaper(@ModelAttribute("newspaper") Tintuc newspaper){
